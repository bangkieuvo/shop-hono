...
//Vo Bang Kieu
function viewModalQuickView(id, name, cost, quantity, description, isLogedIn) {
		//set large Image
		for(let i = 1;i<6;i++){
		document.getElementById('image-large_'+ i).src = '/shop-hono/resources/assets/images/product/list/' + id + '.jpg';			
		}
		
		//set thumbnail Image
		for(let i = 1;i<6;i++){
			document.getElementById('image-thumbnail_'+ i).src = '/shop-hono/resources/assets/images/product/list/' + id + '.jpg';			
			}
		...
		//set cost
		document.getElementById("product-cost").innerHTML = '$' + parseFloat(cost);
