...
<body>
	<c:url value="shop/${pageNow}" var="url" />
	<%
	HttpServletRequest req = request;
	long numberOfProducts = new Long(req.getAttribute("numberOfProducts").toString());
	long numberOfPages = new Long(req.getAttribute("numberOfPages").toString());
	long pageNow = new Long(req.getAttribute("pageNow").toString());
	%>
	<!-- Start Header Area -->
		...
		<div class="container">
			<div class="row flex-column-reverse flex-lg-row">
				<div class="col-lg-12">
								...
								<div
									...
									<div class="sort-tablist d-flex align-items-center">
										<ul class="tablist nav sort-tab-btn">
											<li><a class="nav-link active" data-bs-toggle="tab"
												href="#layout-4-grid"><img
													src="<c:url value="/resources/assets/images/icons/bkg_grid.png"/>"
													alt=""></a></li>
											<li><a class="nav-link" data-bs-toggle="tab"
												href="#layout-list"><img
													src="<c:url value="/resources/assets/images/icons/bkg_list.png"/>"
													alt=""></a></li>
										</ul>
										...
										<div class="page-amount ml-2">
											<%
											long productCount = 12;
											if (pageNow == numberOfPages) {
												productCount = numberOfProducts - (pageNow - 1) * 12;
											}
											%>
											<span>Showing <%=((pageNow - 1) * 12 + 1) + " - " + ((pageNow - 1) * 12 + productCount)%>
												of <%=numberOfProducts%> products
											</span>
										</div>
										<!-- End Page Amount -->
									</div>
												...
												<c:forEach var="product" items="${listProduct}">
													<div class="col-xl-3 col-lg-4 col-sm-6 col-12">
														...
														<div
															...
															<div class="image-box">
																<a
																	href="/shop-hono/product-details/${product.productID}"
																...
																<div class="action-link">
																			...
																			<c:if test="${empty customer}">
																				<p style="color: white;">
																					You are not loged in! <a
																						href="/shop-hono/login?url=shop/${pageNow}">Login</a>
																				</p>
																				</button>
																			</c:if>
																		</form>
																	...
																	<div class="action-link-right">
																		<c:if test="${not empty customer}">
																			<a href="addToWishList/${product.productID}/${url}"><i
															...
															<div class="content">
																<div class="content-left">
																	<h6 class="title">
																		<a
																			href="/shop-hono/product-details/${product.productID}">${product.productName}</a>
																	</h6>
					...
					<!-- Start Pagination -->
					<div class="page-pagination text-center" data-aos="fade-up"
						data-aos-delay="0">
						<ul>
							<%
							for (long pageNo = 1; pageNo <= numberOfPages; pageNo++) {
								if (pageNo == pageNow) {
							%>
							<li><a class="active" href="shop/<%=pageNo%>"><%=pageNo%></a></li>
							<%
							} else {
							%>
							<li><a href="/shop-hono/shop/<%=pageNo%>"><%=pageNo%></a></li>
							<%}%>
							<%}%>
							<li><a href="/shop-hono/shop/<%=numberOfPages%>"><i
