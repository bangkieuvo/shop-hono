							...
							<div class="table_page table-responsive">
								<table>
									...
									<tbody>
										<c:if test="${empty customer}">
											<h2>
												You are not loged in! Please <a href="/shop-hono/login">login</a>
												to view wishlist!
											</h2>
										</c:if>
										<c:if test="${not empty customer}">
											<%
											System.out.println("Wishlist: customer is not null!");
											%>
											<c:forEach var="item" items="${customer.wishList.listItem}">
												...
												<tr>
													...
													<td class="product_thumb"><a
														href="product-details-default.html"><img
															src="<c:url value="/resources/assets/images/product/${item.itemID}/0.jpg"/>"
															alt=""></a></td>
													<td class="product_name"><a
														href="product-details-default.html">${item.itemName}</a></td>
													<td class="product-price">${item.itemCost}</td>
													<td class="product_stock">In Stock</td>
													<td class="product_addcart"><a href="#"
