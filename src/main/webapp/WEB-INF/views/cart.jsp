<%@page import="basePackage.Model.Item"%>
<%@page import="java.util.List"%>
<%@page import="basePackage.Entity.Cart"%>
...
<body>
	...
	<c:if test="${empty customer}">
		<h2>
			You are not loged in! Please <a href="/shop-hono/login/${url}">login</a>
			to view Cart!
		</h2>
	</c:if>
												...
												<c:forEach var="item" items="${customer.cart.listItem}">
													...
													<tr>
														<td class="product_remove"><a
															href="/shop-hono/deleteFromCart?url=${url}&itemID=${item.itemID}"><i
														...
														<td class="product_quantity"><label>Quantity</label>
															<input name="${item.itemID}" min="0"
															max="${item.productQuantity + item.quantity}"
						...
						<div class="coupon_code right" data-aos="fade-up"
							...
							<div class="coupon_inner">
								<div class="cart_subtotal">
									<p>Subtotal:</p>
									<p class="cart_amount">$${customer.cart.getSubTotal()}</p>
								</div>
