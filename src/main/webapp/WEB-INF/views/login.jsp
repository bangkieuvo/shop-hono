				...
				<div class="col-lg-6 col-md-6">
					<div class="account_form" data-aos="fade-up" data-aos-delay="0">
						...
						<c:if test="${not empty prePage}">
							<c:url value="/login_login?url=${prePage}" var="loginPage" />
						</c:if>
						<c:if test="${empty prePage}">
							<c:url value="/login_login" var="loginPage" />
						</c:if>
						<form action="${loginPage}" method="POST">
							<div class="default-form-box">
								<label>Account <span>*</span></label> <input name="account"
									type="text">
							</div>
							<div class="default-form-box">
								<label>Passwords <span>*</span></label> <input name="password"
									type="password">
							</div>
							<div class="login_submit">
								<button class="btn btn-md btn-black-default-hover mb-4"
									type="submit">login</button>
								<!-- <label class="checkbox-default mb-4" for="offer"> <input
									type="checkbox" id="offer"> <span>Remember me</span>
				...
				<div class="col-lg-6 col-md-6">
					<div class="account_form register" data-aos="fade-up"
						...
						<form action="login_register" method="post">
							<div class="default-form-box">
								<label>Account <span>*</span></label> <input type="text"
									name="account">
							</div>
							<div class="default-form-box">
							...
							<div class="default-form-box">
								<label>Passwords again <span>*</span></label> <input
							...
							<div class="default-form-box">
								<label>Middle name<span>*</span></label> <input type="text"
									name="middle-name">
							</div>
							<div class="default-form-box">
